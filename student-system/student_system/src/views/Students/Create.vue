<template>
  <div class="form-page">
    <div class="page-head">
      ...
      <h2 class="font-nunito">🎓 Add New Student</h2>
    </div>
          ...
          <div class="card-body">
            <div class="two-col">
              <div class="form-group">
                ...
                <input v-model="form.name" type="text" class="form-control" placeholder="e.g. Sophea Rith" required />
              </div>
              <div class="form-group">
            ...
            <div class="two-col">
              ...
              <div class="form-group">
                ...
                <input v-model="form.phone" type="tel" class="form-control" placeholder="012-345-678" />
              </div>
            </div>
            <div class="form-group">
              <label class="form-label">Email Address</label>
              <input v-model="form.email" type="email" class="form-control" placeholder="student@school.edu" />
            </div>
            <div class="form-group">
              <label class="form-label">Address</label>
              <input v-model="form.address" type="text" class="form-control" placeholder="City or Province" />
            </div>
          </div>
        </div>
            ...
            <div class="two-col">
              ...
              <div class="form-group">
                ...
                <select v-model="form.status" class="form-control">
                  <option>Active</option><option>At Risk</option><option>Inactive</option>
                </select>
              </div>
            </div>
            <div class="two-col">
              <div class="form-group">
                <label class="form-label">Initial Score (0–100)</label>
                <input v-model.number="form.score" type="number" min="0" max="100" class="form-control" placeholder="0" />
              </div>
              <div class="form-group">
...
const form = reactive({
  ...
  grade:'', status:'Active', score:0, feeStatus:'Pending',
  joinDate: new Date().toISOString().split('T')[0], subjects:[],
})
...
async function handleSubmit() {
  ...
  store.add({ ...form })
  toast.value = `${form.name} added successfully!`
...
@media (max-width: 900px) {
  ...
  .subject-checkboxes { grid-template-columns: repeat(2,1fr); }
}
</style>